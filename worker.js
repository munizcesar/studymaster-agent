...
• Gabarito deve ser defensável perante banca real de concurso.`;
  ...
  const areaMap = {
    ...
    'Psicanálise': 'Use apenas conceitos, autores, teorias e terminologia psicanalítica reconhecidos pela literatura científica consolidada. Autores válidos: Freud, Lacan, Melanie Klein, Winnicott, Bion, Jung, Ferenczi, Abraham, Fromm, Reich, Dolto, Anna Freud. Obras de referência: A Interpretação dos Sonhos (Freud, 1900), Além do Princípio do Prazer (Freud, 1920), O Ego e o Id (Freud, 1923), Escritos (Lacan, 1966), O Seminário (Lacan). NUNCA invente: nomes de conceitos, obras fictícias, casos clínicos inexistentes, autores fabricados ou terminologia que não pertença à tradição psicanalítica reconhecida.',
